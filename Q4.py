...
def create_beasts():
    ...
    return player_one_beast, player_two_beast
...
def play_game(player_one_beast, player_two_beast):
...
def print_winner(player_one_health, player_two_health, player_one_beast, player_two_beast):
...
if __name__ == "__main__":
    create_beasts()
    play_game(player_one_beast, player_two_beast)
    print_winner(player_one_health, player_two_health, player_one_beast, player_two_beast)
